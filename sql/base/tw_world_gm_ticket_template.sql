...
--
-- Dumping data for table `gm_ticket_template`
--

LOCK TABLES `gm_ticket_template` WRITE;
/*!40000 ALTER TABLE `gm_ticket_template` DISABLE KEYS */;
/*!40000 ALTER TABLE `gm_ticket_template` ENABLE KEYS */;
UNLOCK TABLES;
