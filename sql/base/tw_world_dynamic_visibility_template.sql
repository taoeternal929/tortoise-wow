...
--
-- Dumping data for table `dynamic_visibility_template`
--

LOCK TABLES `dynamic_visibility_template` WRITE;
/*!40000 ALTER TABLE `dynamic_visibility_template` DISABLE KEYS */;
/*!40000 ALTER TABLE `dynamic_visibility_template` ENABLE KEYS */;
UNLOCK TABLES;
