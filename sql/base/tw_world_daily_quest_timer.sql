...
--
-- Dumping data for table `daily_quest_timer`
--

LOCK TABLES `daily_quest_timer` WRITE;
/*!40000 ALTER TABLE `daily_quest_timer` DISABLE KEYS */;
INSERT INTO `daily_quest_timer` VALUES (1777878000);
/*!40000 ALTER TABLE `daily_quest_timer` ENABLE KEYS */;
UNLOCK TABLES;
